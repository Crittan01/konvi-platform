...
- `META_VERIFY_TOKEN` = (Este lo inventamos nosotros desde la Fase 3, déjale `"***META_VERIFY_TOKEN_LEGACY_REDACTED***"`).
...
3. **Verify Token:** El que escribiste en el env: `***META_VERIFY_TOKEN_LEGACY_REDACTED***`.
