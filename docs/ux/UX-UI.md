...
| Dónde | Patrón | Regla |
|---|---|---|
| **Inbox** (`chat-panel.tsx`) | `AnimatePresence` + `layout` en burbujas de mensaje nuevas (entrada slide-up 200ms) | El optimistic insert (§3.6) ya da inmediatez; el motion solo orienta. Reducir a fade en reduced-motion |
