...
| ID | Validación | Impacto |
|---|---|---|
| PV-01 | Límites y condiciones de plan pago Render elegido | salida productiva |
| PV-02 | Retry/timeout oficial webhook Meta para endurecer SLA | robustez conversacional |
| PV-03 | Rate limits Aveonline por carrier/endpoint | resiliencia shipping |
