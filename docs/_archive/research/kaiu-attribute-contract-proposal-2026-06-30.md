> **⚠️ ARCHIVADO — 2026-08-02.** Propuesta superseded por ADR-0029 (DECIDIDO el mismo 2026-06-30, `docs/adr/0029-product-model-multi-vertical.md`). Conservado solo como registro de la propuesta original.
