> **⚠️ ARCHIVADO — 2026-08-02.** Diseño no implementado (Meta Suite / Embedded Signup nunca se construyó; el modelo real es Model B Direct Provider per-tenant, ADR-0023). Conservado solo como registro de decisión. No usar como referencia operativa.
...
Ver `docs/_archive/integrations/whatsapp.md` (archivado) para el estado del conector al momento de este diseño; el vigente es `docs/integrations/whatsapp-meta.md`.
...
- `docs/_archive/integrations/whatsapp.md` — Conector WhatsApp al momento de este diseño (legacy, pre-Embedded Signup; archivado)
