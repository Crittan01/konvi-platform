  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main className="flex-1 overflow-y-auto min-w-0">
        ...
        {usedRecoveryCode && (
          <div className="mx-4 sm:mx-6 lg:mx-8 mt-4 rounded-lg border border-warning-border bg-warning-bg px-4 py-3 text-sm text-warning-fg flex items-start gap-3">
