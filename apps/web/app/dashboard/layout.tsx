...
import { LayoutDashboard, ShoppingCart, MessageSquare, LogOut, Package, Users, Settings, Plug, Truck, BarChart2, Boxes, BookOpen, Image, ClipboardList } from 'lucide-react'
      ...
      <aside className="w-64 border-r bg-card flex flex-col justify-between">
        <div className="py-6 px-4">
          ...
          <nav className="space-y-2">
            ...
            <Link href="/dashboard/orders" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
              <Package className="h-4 w-4" /> Pedidos
            </Link>
            <Link href="/dashboard/contacts" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
              <Users className="h-4 w-4" /> Contactos
            </Link>
            <Link href="/dashboard/integrations" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
              <Plug className="h-4 w-4" /> Integraciones
            </Link>
            <Link href="/dashboard/shipping" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
            ...
            <Link href="/dashboard/media" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
            ...
            <Link href="/dashboard/audit" className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground">
