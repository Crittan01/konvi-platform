      ...
      <Card className="max-w-md w-full">
        <CardContent className="pt-8 pb-8 text-center space-y-5">
          ...
          <div className="space-y-1">
            <h2 className="text-lg font-semibold text-foreground">Error al cargar el Catálogo</h2>
            <p className="text-sm text-muted-foreground">
              No se pudieron cargar los productos. Puede ser un problema de conexión temporal.
            </p>
            {error.digest && (
