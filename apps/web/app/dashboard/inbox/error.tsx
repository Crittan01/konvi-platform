      ...
      <Card className="max-w-md w-full">
        <CardContent className="pt-8 pb-8 text-center space-y-5">
          ...
          <div className="space-y-1">
            <h2 className="text-lg font-semibold text-foreground">Error al cargar el Inbox</h2>
            <p className="text-sm text-muted-foreground">
              No se pudieron cargar las conversaciones. Puede ser un problema de conexión temporal.
            </p>
            {error.digest && (
