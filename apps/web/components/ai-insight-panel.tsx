...
const PRIORITY_STYLES: Record<Prioridad, { dot: string; text: string; badge: string }> = {
  alta:  { dot: 'bg-red-400',    text: 'text-red-400',    badge: 'bg-red-400/15 text-red-400 border border-red-400/30' },
  media: { dot: 'bg-amber-400',  text: 'text-amber-400',  badge: 'bg-amber-400/15 text-amber-400 border border-amber-400/30' },
  baja:  { dot: 'bg-green-400',  text: 'text-green-400',  badge: 'bg-green-400/15 text-green-400 border border-green-400/30' },
}
    ...
    return (
      <div className="rounded-xl border border-red-500/30 bg-red-500/5 px-4 py-3 flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium text-red-400">Error al generar análisis</p>
      ...
      <div className="p-4 space-y-4">
        ...
        {hasAlert && (
          <div className="flex items-start gap-2 px-3 py-2.5 rounded-lg bg-red-500/10 border border-red-500/25">
            ...
            <p className="text-xs text-red-400 font-medium leading-relaxed">{insight.alerta}</p>
          </div>
        )}
