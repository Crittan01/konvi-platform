...
/**
 * Table — primitivo del DS (F1 2026-07-04).
 *
 * Reemplaza las 9 tablas hand-rolleadas de la app. Siempre envuelta en un
 * contenedor con overflow-x propio: las tablas anchas scrollean dentro de su
 * caja, nunca la página.
 */
