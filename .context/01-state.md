...
**Branch activo**: `develop`; `production` = **`e94d9931` (deploy 2026-08-30 — 2 fixes UX del cierre: panel recovery codes legible en dark + mensaje real ante 429 de regenerate; solo konvi-web redespliega — los 3 Python quedan en `199f4108` por rootDir sin cambios, mismo binario).** Anterior: `199f4108` (deploy 2026-08-29 — cierre auditoría OWASP completo, verificado live).
