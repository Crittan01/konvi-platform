...
**Última actualización**: 2026-08-25 (**M2.2 CERRADO** — cancelación unificada: pipeline legal completo en `konvi_domain.orders.cancellation` con puertos inyectados + consola cancela con void Wompi/cancel guía/audit SIC/restock + paridad de outcome bot↔paquete certificada (11 escenarios, misma huella DB) + fix enum `order_cancellation_actor` destapado por la certificación live · antes: **M2.1 CERRADO** — OrdersService lecturas+create + `GET /orders/`)
...
**Tests**: 4.707 pytest (316 dbharness) + 363 vitest · ruff ≤196 · CI 5/5 · `certify_stg.sh` 18/18 · validate --ci 24/24.
