...
8. Pendientes founder registrados [F]: desuscribir apps prod de la WABA de prueba (2.5), M19 (verify_token dev), guía UAT 86732771636 por anular en panel Aveonline, **⚠️ deadline Meta 2026-09-30: método de pago en cada WABA o se cortan los service messages** (docs/integrations/whatsapp-meta.md), ~~4 secrets GH para el CI nocturno~~ **✅ REGISTRADOS 2026-08-27 + nightly VERDE verificado** (run 33135919388: **22 pasaron · 0 fallaron · 7 xfail** deuda conocida H1-H8, `money_full_flow` verde, ~15 min — la red de seguridad del reorden vuelve a operar cada noche 02:23 COL). **Track 3 founder-gated con prep del agente ejecutada** (04-next-steps §Track 3): 3.2 gate CI 3.13 listo · 3.4 dry-run PRD 1 objeto/0 errores (listo para --apply con autorización) · 3.1 estado Render medido (falta [F]: CNAME DNS de api.konvi.co; ejecutable por [A] con autorización: custom domain inerte + protected).
