...
**Última actualización**: 2026-08-25 (**M2.1 CERRADO** — OrdersService create/get/list/list_by_contact en `konvi_domain` + `GET /orders/` vivo + consola orders sobre REST + tests de paridad canal↔canal + verificación live STG · antes: **M2 DISEÑO APROBADO founder (4/4) + M2.0 CERRADO** — paquete `packages/shared-py/` vivo)
