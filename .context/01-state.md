...
**Última actualización**: 2026-08-25 (**Track 7 EN CURSO — T7.1+T7.10+T7.5+T7.2 CERRADOS**: escena de auth con firma diferencial en las 4 páginas + `/logout` de marca + topbar con identidad de página (fuente única nav-items) + motion del chat inbox (solo burbujas nuevas, dedupe-proof, verificado live con navegador real; fix DS hidratación-segura `useReducedMotionDS`); directiva founder 2026-08-25: la firma impregna TODO el front · antes: **M2.4 CERRADO — M2 COMPLETO**)
...
**Tests**: 4.826 pytest (316 dbharness) + 384 vitest · ruff ≤196 · CI 5/5 · `certify_stg.sh` 18/18 · validate --ci 25/25.
