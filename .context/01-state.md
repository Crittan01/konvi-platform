...
8. Pendientes founder registrados [F]: desuscribir apps prod de la WABA de prueba (2.5), M19 (verify_token dev), guía UAT 86732771636 por anular en panel Aveonline, **⚠️ deadline Meta 2026-09-30: método de pago en cada WABA o se cortan los service messages** (docs/integrations/whatsapp-meta.md), **4 secrets GH para el CI nocturno del harness (HARNESS_GEMINI_API_KEY, WOMPI_PRIVATE_KEY_SANDBOX, WOMPI_EVENTS_KEY_SANDBOX, AVEONLINE_DEMO_PASSWORD — ver cabecera de `.github/workflows/harness-nightly.yml`)**.
