...
**Ledger**: 269 migraciones repo = **269 ledger prod** (las 7 pendientes aplicadas a PRD 2026-08-27 con protocolo smoke→apply→repair, spot-check de columnas verificado en prod).
**Tests**: 4.847 pytest (316 dbharness) + 435 vitest · ruff ≤196 · CI 5/5 · `certify_stg.sh` 18/18 · validate --ci 25/25.
