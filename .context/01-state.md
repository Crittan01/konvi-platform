...
**Última actualización**: 2026-08-25 (**Track 7 EN CURSO — T7.1+T7.10 CERRADOS**: escena de auth con firma diferencial (`components/auth/auth-scene.tsx`) en login/mfa/forgot/set-password + `/logout` con despedida de marca; directiva founder 2026-08-25: la firma impregna TODO el front · antes: **M2.4 CERRADO — M2 COMPLETO** (ClaimsService 7 ops + consola REST + paridad alarmada))
