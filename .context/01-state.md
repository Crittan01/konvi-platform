...
**Última actualización**: 2026-08-25 (**M2 DISEÑO APROBADO founder (4/4) + M2.0 CERRADO** — paquete `packages/shared-py/` `konvi_domain` vivo: motor de cupones como única fuente, sys.path hack muerto, wiring Render/CI/nightly verificado · antes: **TRACK 5 M1 CERRADO** — inventario verificable 11 dominios · **B-3 CERRADA** — harness serio + REORDEN founder: plataforma primero, BLOQUE BOT AL FINAL)
