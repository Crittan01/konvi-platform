...
# F32 — Fuente única en lib/address_format. Se conserva el nombre `_format_address`
# para callers (build_confirmation_text) + tests. El cuerpo se extrajo verbatim desde
# aquí a lib/address_format.format_address_line; delega sin cambiar comportamiento.
from lib.address_format import format_address_line as _format_address  # noqa: E402
