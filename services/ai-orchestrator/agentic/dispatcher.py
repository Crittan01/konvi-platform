...
# G12: gates determinísticos extraídos a agentic/deterministic_gates.py —
# los nombres quedan en este namespace por el import (callers/tests intactos).
from agentic.deterministic_gates import (  # noqa: F401
    _resolve_contact_id,
    _log_habeas_event,
    _handle_data_rights_if_intent,
    _handle_minor_intent_if_applicable,
    _escalate_conversation_to_human,
    _consume_router_handoff,
    _handle_optout_if_keyword,
