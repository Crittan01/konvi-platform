...
| DB / Auth | Supabase (PostgreSQL + RLS + Auth + Realtime) — 262 migraciones en repo (258 = ledger prod + 4 Track 9 pendientes de aplicar), 79 tablas live |
...
| Tests | 4.849 pytest (306 dbharness) + 358 tests Vitest |
