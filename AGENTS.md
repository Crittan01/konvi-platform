...
| DB / Auth | Supabase (PostgreSQL + RLS + Auth + Realtime) — 266 migraciones repo / 262 ledger prod (4 Track 6 pendientes de deploy), 79 tablas live |
...
| Tests | 4.906 pytest (316 dbharness) + 363 tests Vitest |
