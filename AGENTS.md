...
| DB / Auth | Supabase (PostgreSQL + RLS + Auth + Realtime) — 268 migraciones repo / 262 ledger prod (6 pendientes de deploy), 79 tablas live |
...
| Tests | 4.974 pytest (316 dbharness) + 363 tests Vitest |
