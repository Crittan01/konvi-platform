...
- **Backend**: FastAPI 0.128.8, google-genai==1.47.0
- **DB/Auth**: Supabase PostgreSQL + RLS + Auth + Realtime
- **Hosting**: Render (4 servicios; en Free el orchestrator corre como web + thread daemon)
...
- Python: mantener estilo consistente del módulo (evitar refactors cosméticos innecesarios de tipos)
